...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <?php
      ...
      $youtube_play_url = 'https://www.youtube.com/embed/'.$youtube_id.'?autoplay=0&rel=0';
      $youtube_autoplay_url = 'https://www.youtube.com/embed/'.$youtube_id.'?autoplay=1&rel=0';
    ?>
    <?php if ($youtube_id) { ?>
      <div class="view_video_area">
        <iframe id="youtube_iframe" src="<?php echo $youtube_autoplay_url ?>" frameborder="0" allowfullscreen></iframe>
      </div>
    <?php } ?>
