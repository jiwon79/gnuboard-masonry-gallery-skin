...
<!-- 게시판 목록 시작 { -->
<div id="bo_gall" class="bo_gall" style="width:<?php echo $width; ?>">
            ...
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div class="gall_img">
                      ...
                      <?php }else{
                          $thumb_ori = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], $board['bo_gallery_width'], $board['bo_gallery_height'], false, true);
                         ?>
                        <a href="<?php echo $thumb_ori['ori'] ?>" data-index="<?php echo $i;?>" class="js-smartPhoto" data-caption="<?php echo $list[$i]['subject'] ?>" data-id="<?php echo $list[$i]['subject'] ?>">
                      <?php }
                      ?>
